...
var digit_16046 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_16047__$1 = (vlq >>> (5));
while(true){
if((vlq_16047__$1 > (0))){
var digit_16048__$1 = (digit_16046 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_16048__$1));

var G__16050 = (vlq_16047__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__16051 = (vlq_16047__$1 >>> (5));
digit_16046 = G__16050;
vlq_16047__$1 = G__16051;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_16046));
}
break;
}
