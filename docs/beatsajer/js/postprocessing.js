    ...
    _createClass(BlurPass, [{
      ...
      value: function render(renderer, inputBuffer, outputBuffer, delta, stencilTest) {
        ...
        for (i = 0, l = kernel.length - 1; i < l; ++i) {
          ...
          renderer.render(scene, camera, destRT, null, true);
          lastRT = destRT;
        }
        ...
        uniforms.kernel.value = kernel[i];
        uniforms.inputBuffer.value = lastRT.texture;
        renderer.render(scene, camera, this.renderToScreen ? null : outputBuffer, null, true);
      }
    }, {
      key: "setSize",
      value: function setSize(width, height) {
  ...
  var EffectPass = function (_Pass) {
    ...
    _createClass(EffectPass, [{
      ...
      value: function render(renderer, inputBuffer, outputBuffer, delta, stencilTest) {
        ...
        renderer.render(this.scene, this.camera, this.renderToScreen ? null : outputBuffer, null, true);
      }
    }, {
      key: "setSize",
      value: function setSize(width, height) {
